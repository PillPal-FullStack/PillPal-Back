...
public class ReminderController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "List of reminders for medication obtained", content = @Content(schema = @Schema(implementation = ReminderResponse.class))),
            @ApiResponse(responseCode = "500", description = "Internal server error")
    })
    public ResponseEntity<List<ReminderResponse>> getRemindersByMedicationId(
